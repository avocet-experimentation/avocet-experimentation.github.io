...
description: When developing Avocet, we made two critical technical design choices: (1) optimize for flag read performance, and (2) provide great flexibility in how Avocet can be deployed.
---
