...
description: This section details the technical hurdles faced by the Avocet team during development, highlighting innovative solutions to complex engineering challenges.
---
...
<a href="/content/case-study/engineering-decisions#integrate-with-any-telemetry-pipeline">use GraphQL to make our project work with any telemetry database</a>.
